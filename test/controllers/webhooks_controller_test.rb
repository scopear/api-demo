...
class WebhooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webhook" do
    assert_difference('Webhook.count') do
      post webhooks_url, params: { webhook: { api_response: @webhook.api_response, origin: @webhook.origin, payload: @webhook.payload } }
    end
  ...
  test "should update webhook" do
    patch webhook_url(@webhook), params: { webhook: { api_response: @webhook.api_response, origin: @webhook.origin, payload: @webhook.payload } }
